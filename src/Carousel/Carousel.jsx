...
function Carousel() {
  return (
    <Card className="bg-dark text-white shadow-lg m-5" style={{ borderRadius: '10px' }}>
      ...
      <Card.Img src={Professional_Chief} alt="Card image" style={{ filter: 'brightness(50%)', opacity: 0.8 }} />
        ...
        <div>
          <div className='text-center pb-3'>
            ...
            <Card.Text>
              ...
              embark on a journey filled with <br /> mouthwatering recipes, expert techniques, and the secrets to creating unforgettable dishes. Let your kitchen tales unfold here!
            </Card.Text>
          </div>
          <br />
